...
const editSVG = () =>{
    return(
        <svg margin="10px" xmlns="http://www.w3.org/2000/svg"  version="1.1" id="Слой_1" x="0px" y="0px" width="23px" height="23px" viewBox="0 0 1000 1000" enable-background="new 0 0 1000 1000" >
